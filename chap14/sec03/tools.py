...
if __name__ == "__main__":
    ...
    # documents = web_page_json_to_documents(f'{current_path}/data/resources_2025_0921_154435.json') 
    # print(documents[-1])

    # splits = split_documents(documents)
    # print(splits)

    # add_web_pages_json_to_chroma(f'{current_path}/data/resources_2025_0921_154435.json')

...
| `MAX_CHUNKS_PER_DOC` | 15 | **0**(비활성) | ✅ 2026-07-30 CFG 필드 안 채움 — `.env`에 설명 주석만 덧붙임(줄은 활성 유지). 채우면 긴 문서가 15조각에서 절단 |
...
| 2026-07-30 | OBSERVED §1 조치 완료 표기 + §5 `.env` untracked 규율 + STANDARDS §1.3 0단 확인 명령 | `fc7a2a12` |
...
| 2026-07-31 | CLAUDE.md §4 커밋 범위 문구 정정 — 원자료 차단·`.md` 포함·`!` 예외 체계 명시. §3-5 닫힘 | `2465193b` |

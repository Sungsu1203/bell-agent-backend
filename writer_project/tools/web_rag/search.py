...
# ── Google CSE Base URL (ENV override 가능) ────────────────────────────────
# 기본 권장 엔드포인트: https://customsearch.googleapis.com/customsearch/v1
GOOGLE_CSE_BASE_URL = (
    os.getenv("GOOGLE_CSE_BASE_URL", "https://customsearch.googleapis.com/customsearch/v1")
    .strip()
)
